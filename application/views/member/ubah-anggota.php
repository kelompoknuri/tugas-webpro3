...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-9"> 
		<?= form_open_multipart('member/ubahprofil'); ?> <div class="form-group row"> <label
            ...
            <div class="form-group row justify-content-end">
                ...
                <a class="btn btn-primary" href="<?php echo base_url('member/myprofil') ?>"><span>Kembali</span></a>
            </div>
            </div>
            </form>
        </div>
