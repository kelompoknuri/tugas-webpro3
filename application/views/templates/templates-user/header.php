        ...
        <div class="navbar-nav m-auto">
            ...
            <!-- baru -->
                ...
                <?php if (!empty($this->session->userdata('email'))) { ?>
                    <a class="nav-item nav-link text-white" href="<?= base_url('booking'); ?>">Booking <b>
                    ...
                    <i class="fas fw fa-login"></i> Log out</a>
                        ...
                        <span class="nav-item nav-link nav-right text-white float-right" style="display:block; margin-left:20px;">Selamat Datang<b> &nbsp;<?= $user; ?></b></span> 
                    </div> 
                </nav> 
