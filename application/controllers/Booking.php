...
{ 
    ...
    //     redirect(base_url()); 
    // }
    public function tambahBooking() { $id_buku = $this->uri->segment(3); 
        ...
        $databooking = $this->db->query("select*from booking where id_user='$userid'")->num_rows(); 
            ...
            if ($tempuser == 3) { $this->session->set_flashdata('pesan', 
            ...
            $this->ModelBooking->createTemp(); $this->ModelBooking->insertData('temp', $isi); 
